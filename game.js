...
function updateStatsUI() {
    ...
    const wsh = document.getElementById('win-stat-high'); if (wsh) wsh.textContent = stats.highScore || 0;
    const wsb = document.getElementById('win-stat-bestwave'); if (wsb) wsb.textContent = stats.bestWave || 0;
}
